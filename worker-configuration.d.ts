/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8a2ef4e05a9d925b34af3128f255eee5)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		SEED_NAME: string;
		IMPORT_PLANT_WORKFLOW: Workflow<Parameters<import("./src/server").ImportPlantWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TAVILY_API_KEY" | "OPENAI_API_KEY" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "SEED_SECRET" | "SEED_EMAIL" | "SEED_PASSWORD" | "SEED_NAME">> {}
}
